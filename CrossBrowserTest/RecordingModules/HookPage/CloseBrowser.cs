...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("5931ed7d-0db2-4e5a-a5fa-b12a4770b7dd", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'JupiterPrimeGoogleChrome'.", repo.JupiterPrimeGoogleChrome.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.JupiterPrimeGoogleChrome.Self, 1000);
